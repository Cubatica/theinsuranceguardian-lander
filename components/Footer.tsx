      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-300 mb-2">
            <strong>The Insurance Guardian.com</strong>
          </p>
          <p className="text-gray-300 mb-2">
            Phone: <a href="tel:+17045551234" className="hover:text-yellow-400">(704) 555-1234</a>
          </p>
          <p className="text-gray-300">
            Email: <a href="mailto:info@theinsuranceguardian.com" className="hover:text-yellow-400">info@theinsuranceguardian.com</a>
          </p>
        </div>
      </div>
