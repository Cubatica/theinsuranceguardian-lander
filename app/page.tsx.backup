    ...
    <>
      ...
      <section id="services" className="bg-gray-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="section-title">Why Choose The Insurance Guardian?</h2>
      ...
      <section id="contact" className="relative bg-gradient-to-br from-blue-700 via-blue-600 to-blue-500 text-white py-20 px-4 overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto relative z-10 text-center">
          ...
          <p className="text-sm text-blue-100 mt-4">
            Call us at <a href="tel:+17045551234" className="underline font-semibold">(704) 555-1234</a> or email us at <a href="mailto:info@theinsuranceguardian.com" className="underline font-semibold">info@theinsuranceguardian.com</a>
          </p>
        </div>
      </section>
