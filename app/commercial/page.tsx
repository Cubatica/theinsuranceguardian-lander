...
export default function AutoLanderGG() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      ...
      meta.content = "Get a FREE commercial quote. Compare plans and save up to 50% on your business insurance.";
          ...
          <div className="flex items-center justify-between gap-2 md:gap-4">
            <div className="flex items-center gap-2 md:gap-4 flex-1 min-w-0">
              ...
              <p className="text-sm md:text-lg font-semibold text-gray-900 hidden lg:block truncate">
                Find the best savings on commercial easily and fast
              </p>
            </div>
            {/* Mobile Menu Button */}
            <button
      ...
      <main className="relative pt-16 md:pt-20">
        ...
        <section className="relative py-16 px-4 md:py-24 overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: 'url(https://cdn.convertri.com/95e046c4-fcd2-11ea-abef-0697e5ca793e%2F85a0af8f466613d6105cccc3d3f59cbfe0d712b8%2Fbackground_image-commercial2.jpg)'
            }}
          ></div>
            ...
            <div className="flex justify-start">
              ...
              <div className="bg-white rounded-xl shadow-xl p-8 md:p-10 border border-gray-200 max-w-md">
                <div className="flex items-center gap-4 mb-6">
                  <img
                    src="https://convertri.imgix.net/95e046c4-fcd2-11ea-abef-0697e5ca793e%2F0d83dbdea3aaba0f35d20b1612cbec8425dc42da%2Fcommercial%20insurance%20logo.png?auto=compress,format&fit=scale&w=92&h=92"
                    alt="Commercial icon"
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center md:text-left">
                ...
                <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
                  3 steps to compare commercial quotes
                </h1>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Fill out the form to tell us about yourself and your business coverage needs. It takes about 5 minutes. You'll get a FREE commercial quote from a local agency or carrier customized to your unique profile.
                  </p>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Compare that quote with your current commercial plan, or get a second quote and compare them. See how your new quotes stack up against what you're currently paying.
                  </p>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Are you getting the best deal? If one of your new commercial quotes has a better rate, you can swap plans and start saving.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  We've already helped 300,000+ people shop for commercial
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Request commercial quotes in 5 minutes or less. No sign-up required
                </p>
              </div>
