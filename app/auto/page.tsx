...
export default function AutoLanderGG() {
  ...
  useEffect(() => {
    document.title = "Auto Insurance Quotes - OptimumSeniors.com";
  ...
  return (
    <>
      ...
      {/* <Script
        ...
        src="https://clk.optimum-seniors.com/unilpclick.js?attribution=lastpaid&cookiedomain=&cookieduration=90&defaultcampaignid=6939a450b0e10db07911d34a&regviewonce=false"
      /> */}
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <h3 className="text-3xl md:text-5xl font-bold text-gray-900 text-center mb-12">
              Why compare car quotes with OptimumSeniors?
            </h3>
